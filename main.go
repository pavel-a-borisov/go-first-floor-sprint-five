...
type Training struct {
	TrainingType string        // тип тренировки — описывает вид тренировки (Бег, Ходьба, Плавание);
	Action       int           // количество повторов(шаги, гребки при плавании) - описывает количество шагов при беге и ходьбе или количество гребков при плавании
...
func (r Running) TrainingInfo() InfoMessage {
	...
	//Для реализации этого метода для структуры Swimming{} нужно вернуть вызов такого же метода TrainingInfo(),
...
// ((CaloriesWeightMultiplier * вес_спортсмена_в_кг + (средняя_скорость_в_метрах_в_секунду**2 / рост_в_метрах) * CaloriesSpeedHeightMultiplier * вес_спортсмена_в_кг) * время_тренировки_в_часах * MinInHours)
// Это переопределенный метод Calories() из Training.
